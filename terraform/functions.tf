...
resource oci_functions_application export_project_1 {
  ...
  config = {
    ...
    "APP_URL"           = "https:// .apigateway.eu-frankfurt-1.oci.customer-oci.com/testimonial"
    "AUTH_URL"          = "https:// .apigateway.eu-frankfurt-1.oci.customer-oci.com/login"
    "SIGNUP_URL"        = "https:// .eu-frankfurt-1.oci.customer-oci.com/welcome?action=signup"
    "WELCOME_URL"       = "https:// .eu-frankfurt-1.oci.customer-oci.com/welcome"
    "CAROUSEL_PAGE_URL" = "https://objectstorage.eu-frankfurt-1.oraclecloud.com/n/${data.oci_objectstorage_namespace.tenancy_namespace.namespace}/b/pub/o/login_carousel.html"
    "PAGE_URL"          = "https://objectstorage.eu-frankfurt-1.oraclecloud.com/n/${data.oci_objectstorage_namespace.tenancy_namespace.namespace}/b/pub/o/testimonial.html"
    "SIGNUP_PAGE_URL"   = "https://objectstorage.eu-frankfurt-1.oraclecloud.com/n/${data.oci_objectstorage_namespace.tenancy_namespace.namespace}/b/pub/o/login.html"
    "GENAI_ENDPOINT"    = "https://inference.generativeai.eu-frankfurt-1.oci.oraclecloud.com"
    "GENAI_OCID"        = "ocid1.generativeaimodel.oc1.eu-frankfurt-1...."
    "IDCS_URL"          = "idcs-"
    "DB_URL"            = ""
    "DB_USER"           = "admin"
    "DB_PASSWORD"       = ""
