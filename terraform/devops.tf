...
resource oci_devops_deploy_pipeline export_project-testimonials {
  
  #deploy_pipeline_parameters {
  #}
  description  = ""
  display_name = "${var.project_name}-testimonials"
  freeform_tags = {
  }
  project_id = oci_devops_project.export_project.id
}

resource oci_devops_deploy_pipeline export_project-authorizer {
  
  #deploy_pipeline_parameters {
  #}
  
  description  = ""
  display_name = "${var.project_name}-authorizer"
  freeform_tags = {
  }
  project_id = oci_devops_project.export_project.id
}

resource oci_devops_deploy_environment export_fn_1 {
...
resource oci_devops_deploy_environment export_fn_2 {
  #cluster_id = <<Optional value not found in discovery>>
  #compute_instance_group_selectors = <<Optional value not found in discovery>>
...
resource oci_devops_deploy_artifact export_project-testimonials_1 {
  ...
  deploy_artifact_source {
    ...
    image_digest = ""
    image_uri    = "${var.registry}/${data.oci_objectstorage_namespace.tenancy_namespace.namespace}/${var.image_name_testimonials}:$${buildId}"
...
resource oci_devops_deploy_artifact export_project-authorizer_1 {
  argument_substitution_mode = "SUBSTITUTE_PLACEHOLDERS"
  ...
  deploy_artifact_source {
    ...
    #helm_verification_key_source = <<Optional value not found in discovery>>
    image_digest = ""
    image_uri    = "${var.registry}/${data.oci_objectstorage_namespace.tenancy_namespace.namespace}/${var.image_name_authorizer}:$${buildId}"
    #repository_id = <<Optional value not found in discovery>>
  }
  deploy_artifact_type = "DOCKER_IMAGE"
  description          = ""
...
resource oci_devops_project export_project {
  ...
  description = "OCI DevOps project for Testimonials OCI Functions App"
  freeform_tags = {
  }
...
resource oci_devops_build_pipeline export_project-testimonials_2 {
  build_pipeline_parameters {
    ...
    items {
      name = "IMAGE_NAME"
      default_value = "${var.image_name_testimonials}"
    }
  }
  
  description  = "Build of Testimonials App image"
  display_name = "${var.project_name}-testimonials"
  freeform_tags = {
  }
  project_id = oci_devops_project.export_project.id
...
resource oci_devops_build_pipeline export_project-authorizer_2 {
  build_pipeline_parameters {
    items {
      name = "NAMESPACE"
      default_value = "${data.oci_objectstorage_namespace.tenancy_namespace.namespace}"
    ...
    items {
      name = "IMAGE_NAME"
      default_value = "${var.image_name_authorizer}"
    }
  }
  
  description  = "Build of Authorizer image"
  display_name = "${var.project_name}-authorizer"
  freeform_tags = {
  }
  project_id = oci_devops_project.export_project.id
...
resource oci_devops_deploy_stage export_deploy {
  ...
  deploy_pipeline_id = oci_devops_deploy_pipeline.export_project-testimonials.id
  deploy_stage_predecessor_collection {
    items {
      id = oci_devops_deploy_pipeline.export_project-testimonials.id
    }
  }
  ...
  description                     = ""
  display_name                    = "deploy"
  docker_image_deploy_artifact_id = oci_devops_deploy_artifact.export_project-testimonials_1.id
  #failure_policy = <<Optional value not found in discovery>>
  freeform_tags = {
  }
  function_deploy_environment_id = oci_devops_deploy_environment.export_fn_1.id
...
resource oci_devops_deploy_stage export_deploy_1 {
  ...
  #deploy_environment_id_a = <<Optional value not found in discovery>>
  #deploy_environment_id_b = <<Optional value not found in discovery>>
  deploy_pipeline_id = oci_devops_deploy_pipeline.export_project-authorizer.id
  deploy_stage_predecessor_collection {
    items {
      id = oci_devops_deploy_pipeline.export_project-authorizer.id
    }
  }
  deploy_stage_type = "DEPLOY_FUNCTION"
  #deployment_spec_deploy_artifact_id = <<Optional value not found in discovery>>
  description                     = ""
  display_name                    = "deploy"
  docker_image_deploy_artifact_id = oci_devops_deploy_artifact.export_project-authorizer_1.id
  #failure_policy = <<Optional value not found in discovery>>
  freeform_tags = {
  }
  function_deploy_environment_id = oci_devops_deploy_environment.export_fn_2.id
  function_timeout_in_seconds    = "30"
  #green_backend_ips = <<Optional value not found in discovery>>
  #helm_chart_deploy_artifact_id = <<Optional value not found in discovery>>
  #helm_command_artifact_ids = <<Optional value not found in discovery>>
...
resource oci_devops_repository export_project_1_1 {
  default_branch = "refs/heads/main"
  
  description = ""
  freeform_tags = {
  }
  name                 = "${var.image_name_testimonials}"
  parent_repository_id = ""
  project_id           = oci_devops_project.export_project.id
  repository_type      = "HOSTED"
}

resource oci_devops_repository export_project_1_2 {
  default_branch = "refs/heads/main"
  
  description = ""
  freeform_tags = {
  }
  name                 = "${var.image_name_authorizer}"
  parent_repository_id = ""
  project_id           = oci_devops_project.export_project.id
  repository_type      = "HOSTED"
}
...
resource oci_devops_build_pipeline_stage export_deploy_2 {
  build_pipeline_id = oci_devops_build_pipeline.export_project-testimonials_2.id
...
resource oci_devops_build_pipeline_stage export_deploy_3 {
  build_pipeline_id = oci_devops_build_pipeline.export_project-authorizer_2.id
  build_pipeline_stage_predecessor_collection {
    items {
...
#    items {
#      artifact_id   = oci_devops_deploy_artifact.export_project-testimonials_1.id
#      artifact_name = "image-testimonials"
#    }
#  }
...
resource oci_devops_build_pipeline_stage export_build {
  ...
  build_pipeline_stage_predecessor_collection {
    items {
      id = oci_devops_build_pipeline.export_project-testimonials_2.id
    }
  }
  ...
  build_source_collection {
    items {
      ...
      name            = "${var.image_name_testimonials}"
      repository_id   = oci_devops_repository.export_project_1_1.id
  ...
  #is_pass_all_parameters_enabled = <<Optional value not found in discovery>>
  primary_build_source               = "${var.image_name_testimonials}"
...
#  deliver_artifact_collection {
#    items {
#      artifact_id   = oci_devops_deploy_artifact.export_project-authorizer_1.id
#      artifact_name = "image-authorizer"
#    }
#  }
#  #deploy_pipeline_id = <<Optional value not found in discovery>>
#  description  = ""
...
resource oci_devops_build_pipeline_stage export_build_1 {
  ...
  build_pipeline_stage_predecessor_collection {
    items {
      id = oci_devops_build_pipeline.export_project-authorizer_2.id
    }
  }
  build_pipeline_stage_type = "BUILD"
  build_runner_shape_config {
  ...
  build_source_collection {
    items {
      ...
      connection_type = "DEVOPS_CODE_REPOSITORY"
      name            = "${var.image_name_authorizer}"
      repository_id   = oci_devops_repository.export_project_1_2.id
  ...
  image = "OL7_X86_64_STANDARD_10"
  #is_pass_all_parameters_enabled = <<Optional value not found in discovery>>
  primary_build_source               = "${var.image_name_authorizer}"
  stage_execution_timeout_in_seconds = "36000"
  #wait_criteria = <<Optional value not found in discovery>>
}

resource oci_devops_repository_ref export_project_1_repository_ref_1 {
...
resource oci_devops_repository_ref export_project_1_repository_ref_2 {
  commit_id = "7f9251b0eb58f0551edc8077037e12bf3b391c5d"
  #object_id = <<Optional value not found in discovery>>
  ref_name      = "main"
  ref_type      = "BRANCH"
